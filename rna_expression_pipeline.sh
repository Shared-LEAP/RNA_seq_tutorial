...
fastqc <Your Sample RNA Files Unzipped>*.fastq -o FastQC_reads
...
fastq_files=(<Your Sample RNA Files Unzipped>*.fastq)
...
# You need mouse or human reference, This assumes you have it
GENOME_FASTA="/rsem_reference/GRCm39.primary_assembly.genome.fa"
GTF_FILE="/rsem_reference/gencode.vM31.primary_assembly.annotation.gtf"
...
rsem-prepare-reference \
    ...
    -p 10 \
    "$GENOME_FASTA" \
    /RSEM_reference/mouse_reference
...
trimmed_files=(/Trimmed_reads/*_trimmed.fastq)
